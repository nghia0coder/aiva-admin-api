...
**Updated `tests\Aiva.Admin.Api.FunctionalTests\Aiva.Admin.Api.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Aiva.Admin.Api.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Aiva.Admin.Api.FunctionalTests\Aiva.Admin.Api.FunctionalTests.csproj
```
